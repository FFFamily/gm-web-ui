...
export const storeItems = [
  ...
  { id: 2, name: '等离子转换器', price: 1000, quality: 'green', stats: { health: 30 } },
  { id: 3, name: '补偿器', price: 1000, quality: 'green', stats: { cooldown: 5 } },
  { id: 4, name: '弹药储备', price: 1500, quality: 'green', stats: { damage: 8 } },
  { id: 5, name: '狂热增幅器', price: 1500, quality: 'green', stats: { damage: 8 } },
  { id: 5, name: '平流层信标', price: 1500, quality: 'green', stats: { damage: 8 } },
